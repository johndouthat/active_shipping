...
if !mangles_tag_names # i.e. ActiveSupport::VERSION::STRING < '2.3.0'
  module ActiveMerchant  #:nodoc:
    module ParsesXml  #:nodoc:
      def parse_xml(xml)
        Hash.from_xml(xml)
      end
    end
  ...
  # Include XMLSimple, the patches to XMLSimple from ActiveSupport 2.2.2
  # Then adds method Hash.from_xml_old_style(xml)
  # This is copied entirely from ActiveSupport 2.2.2

  # Then defines ParsesXml#parse_xml
  ...
  class Hash
    ...
    def self.from_xml_old_style(xml)
...
module ActiveMerchant
  self.extend(ActiveMerchant::ParsesXml)
end